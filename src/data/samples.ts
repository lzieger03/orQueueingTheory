...
export const sampleHistoricalData = [
  // Weekday data (based on real Monday data)
  {
    ...
    regularStations: 2 // Default number of regular stations for weekdays
  },
  ...
  // Weekend data (based on real Saturday data)
  {
    ...
    regularStations: 4 // Default number of regular stations for weekends
  }
];
...
export const storeLayouts = {
  basic: {
    stations: [
      { id: 'station-2', type: 'regular' as const, position: { x: 200, y: 100 }, size: { width: 80, height: 60 }, isActive: true, servingCustomer: null, queue: [], serviceTime: realStoreData.weekday.avgServiceTime, onBreak: false },
    ]
  },
  small: {
    stations: [
      { id: 'station-1', type: 'regular' as const, position: { x: 100, y: 100 }, size: { width: 80, height: 60 }, isActive: true, servingCustomer: null, queue: [], serviceTime: realStoreData.weekday.avgServiceTime, onBreak: false },
    ]
  },
  mixed: {
    stations: [
      { id: 'station-3', type: 'regular' as const, position: { x: 100, y: 100 }, size: { width: 80, height: 60 }, isActive: true, servingCustomer: null, queue: [], serviceTime: realStoreData.weekday.avgServiceTime, onBreak: false },
      { id: 'station-4', type: 'regular' as const, position: { x: 250, y: 100 }, size: { width: 80, height: 60 }, isActive: true, servingCustomer: null, queue: [], serviceTime: realStoreData.weekday.avgServiceTime, onBreak: false },
      { id: 'station-5', type: 'kiosk' as const, position: { x: 400, y: 100 }, size: { width: 60, height: 40 }, isActive: true, servingCustomer: null, queue: [], serviceTime: Math.round(realStoreData.weekday.avgServiceTime * 1.2), onBreak: false },
    ]
  }
};
